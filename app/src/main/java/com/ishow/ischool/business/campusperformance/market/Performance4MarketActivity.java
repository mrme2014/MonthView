...
//                                    month = endDateMonth;
                                    ToastUtil.showToast(Performance4MarketActivity.this, getString(R.string.start_than_end));
                                    return;
                                } else {
...
//                                  month = startDateMonth;
                                    ToastUtil.showToast(Performance4MarketActivity.this, getString(R.string.end_le_start));
                                    return;
                                } else {
