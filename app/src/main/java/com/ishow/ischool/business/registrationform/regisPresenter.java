...
public class regisPresenter extends BasePresenter<regisModel, regisView> {
    ...
    public void payAction(int studentid, String pay_method_json, String action, float price, float actual_price, String receipt_no, String memo,int privilege_type,double cheap_price, HashMap<String, Integer> time) {
