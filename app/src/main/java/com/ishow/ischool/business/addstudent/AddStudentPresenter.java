...
public class AddStudentPresenter extends AddStudentContract.Presenter {
    ...
    @Override
    void addStudent(String name, String mobile, String qq, int province_id, int city_id, int campus_id, int college_id, String major, int source, int referrer, String notes) {
        mModel.addStudent(name, mobile, qq, province_id, city_id, campus_id, college_id, major, source, referrer, notes)
