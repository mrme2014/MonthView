...
public interface UserApi {
    ...
    Observable<ApiResult<User>> change(@Field("resources_id") int resources_id, @Field("campus_id") int campus_id, @Field("position_id") int position_id, @Field("fields") String fields);
    ...
    Observable<ApiResult<JsonElement>> checkrandcode(
