package monthview.ishow.com.monthview.pull;//package com.commonlib.widget.pull;
//
///**
// * Created by wqf on 16/7/4.
// * notifyItemChanged(position)闪烁主要由于RecyclerView使用的默认的动画导致的，所以解决的方法就是修改默认的动画。
// */
///*
